...
print('<a href="../lcoetc/html/lvmetc.html">Return to LVM ETC</a>')
print("<br/>")
print("<br/>")

print('<a href="../lcoetc/lvmetc_out.dat" download>Download ASCII Table with Results</a>')
print("<br/>")

print('<a href="../lcoetc/tmp/lvmetc_out.fits" download>Download FITS with Simulated 2D Spectrum</a>')
print("<br/>")

print('<a href="../lcoetc/tmp/lvmetc_out.png" download>Download Plots</a>')
print("<br/>")

print("<br/>")

print('<img src="../lcoetc/tmp/lvmetc_out.png">')
